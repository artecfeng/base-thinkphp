    ...
    class Users extends Migrator {
        ...
        public function change () {
            ...
            $table->addColumn('username', 'string', array(
                ...
                'default' => md5('123456'),
                'comment' => '用户密码'
            ))->addColumn('login_token', 'string', array(
                'limit'   => 32,
                'default' => md5('123456'),
                'comment' => '用户密码'
            ))->addColumn('login_status', 'boolean', array(
                'limit'   => 1,
                'default' => 0,
                'comment' => '登陆状态'
            ))->addColumn('login_code', 'string', array(
                'limit'   => 32,
                'default' => 0,
                'comment' => '排他性登陆标识'
                ...
                'default' => 0,
                'comment' => '最后登录IP'
            ))->addColumn('last_login_time', 'datetime', array(
                'default' => '1990-01-01 00:00:00',
                'comment' => '最后登录时间'
            ))->addColumn('is_delete', 'boolean', array(
                'limit'   => 1,
                'default' => 0,
                'comment' => '删除状态，1已删除'
